                ...
                if app:
                    with app.app_context():
                        ...
                        try:
                            ...
                            admin_log_text = (
                                f"⚠️ <b>Neue Verwarnung erteilt (Auto-Mod Profanity)</b>\n\n"
                                f"👤 <b>Nutzer:</b> {target_mention} (ID: {target_user.telegram_id})\n"
                                f"🛡️ <b>Verwarnt durch:</b> System (Filter)\n"
                                f"⚖️ <b>Grund:</b> Automatischer Beleidigungsfilter: '{word}'\n"
                                f"📊 <b>Status:</b> {warning_count}/{max_warns}"
                            )
                                ...
                                with app_ctx.app_context():
                                    try:
                                        ...
                                        if db_msg:
                                            ...
                                            db_msg.deleted_by_name = "System (Filter)"
                                            db.session.commit()
